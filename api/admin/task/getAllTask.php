...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_GET['trackid'])) {
        ...
        $sortQuery .= ' AND ' . $taskDBCall::tableName . '.trackid = ?';
        $paramString .= "s";
        $params[] = $status;
    } else {
        $single_post = false;
    ...
    if (isset($_GET['search'])) {
        $tableName = $taskDBCall::tableName;
    ...
    $AllReview = $taskDBCall::getAllTask($page_no, $offset, $noPerPage, $searchQuery, $sortQuery, $paramString, $params);
