...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $task = " ";
    if (isset($_POST['task'])) {
        $task = $utility_class_call::escape($_POST['task']);
    }

    // checking all paramater are passed

    if (
        $utility_class_call::validate_input($user_id) || $utility_class_call::validate_input($task)
    ) {
    ...
    $StaffReview = $taskDBCall::addTask($data);
    ...
    $maindata = [];
    $text = $api_response_class_call::$staffTask;
